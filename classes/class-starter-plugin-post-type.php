...
class Starter_Plugin_Post_Type
{
     ...
     * @since 1.0.0
     */
    public function __construct($post_type = 'thing', $singular = '', $plural = '', $args = [], $taxonomies = [])
    {
        ...
        add_action('after_setup_theme', [$this, 'ensure_post_thumbnails_support']);
        add_action('after_theme_setup', [$this, 'register_image_sizes']);
    }
 ...
 // End register_custom_columns()
    ...
    {
        $new_columns = ['image' => __('Image', 'starter-plugin')];
 ...
 // End updated_messages()
    ...
    {
        add_meta_box($this->post_type.'-data', __('Thing Details', 'starter-plugin'), [$this, 'meta_box_content'], $this->post_type, 'normal', 'high');
    }
